...
<template>
  <div class="flex-wrapper">
    <!-- 头部固定联系栏 -->
    <v-commonManageMoneyProductItem :todaytime="this.$route.params.todaytime"
                                ...
                                v-if="productType==1"></v-commonManageMoneyProductItem>
    <v-commonFundProductItem :todaytime="this.$route.params.todaytime"
                         :userid="this.$route.params.userid"
                         :fieldid="this.$route.params.fieldid"
                         :openid="this.$route.params.openid"
                         :isShare="this.$route.params.isShare"
                         ...
                         :historyid="this.$route.params.historyid"
                         :isWXApplet="this.$route.params.isWXApplet"
                         v-else-if="productType==2"></v-commonFundProductItem>
...
//Vuex公共状态动作
  ...
  import commonManageMoneyProductItem from '../../components/common/commonProductItem/commonManageMoneyProductItem'
  import commonFundProductItem from '../../components/common/commonProductItem/commonFundProductItem'
  //执行成功
  ...
  export default {
    ...
    components: {
      'v-linkman': linkman,
      'v-commonManageMoneyProductItem': commonManageMoneyProductItem,
      'v-commonFundProductItem': commonFundProductItem,

...
<script>
  ...
  export default {
    ...
    methods: {
      checkArticle() {
        window.location.replace('https://' + process.env.VUE_APP_LINK + '.yihuisoft.com/' + process.env.VUE_APP_FRONT + '/#/financialReport30/' + this.nowDate + '/' + this.userid + '/' + this.shareArticleId + '/' + this.openid + "/" + 1);
      }
    },
    created() {

  ...
  export default {
    ...
    methods: {
      ...
      wxRegCallback() {
        ...
        var shareUrl = 'https://' + process.env.VUE_APP_LINK + '.yihuisoft.com/' + process.env.VUE_APP_FRONT + '/#/seeCommonProduct/' + this.nowDate + '/' + this.userid + '/' + this.productId + "/" + this.openid + '/' + this.nowDate + "/2/T9";
